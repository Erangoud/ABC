...
ALLOWED_HOSTS = ['*','ALB-FRONTEND-872435850.ap-south-1.elb.amazonaws.com']
...
load_dotenv(dotenv_path='/etc/fundoo/env.conf') 
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',  # Use PostgreSQL
        'NAME': os.getenv('DB_NAME'),              # Get DB name from environment variable
        'USER': os.getenv('DB_USER'),              # Get DB user from environment variable
        'PASSWORD': os.getenv('DB_PASSWORD'),      # Get DB password from environment variable
        'HOST': os.getenv('DB_HOST'),              # Get DB host from environment variable
        'PORT': os.getenv('DB_PORT')              # Get DB port from environment variable
    }
}
# Other settings...
...
CSRF_TRUSTED_ORIGINS = [
    'http://65.0.92.195',  
    'http://alb-frontend-872435850.ap-south-1.elb.amazonaws.com'
]
